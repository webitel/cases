...
require (
	buf.build/gen/go/webitel/webitel-go/grpc/go v1.5.1-20250722101930-930ffcd444d7.2
	buf.build/gen/go/webitel/webitel-go/protocolbuffers/go v1.36.1-20250722101930-930ffcd444d7.1
