...
require (
	buf.build/gen/go/webitel/webitel-go/grpc/go v1.5.1-20250910193322-4af2788d725d.2
	buf.build/gen/go/webitel/webitel-go/protocolbuffers/go v1.36.1-20250910193322-4af2788d725d.1
