...
require (
	buf.build/gen/go/webitel/webitel-go/grpc/go v1.5.1-20250916131900-90d895efdd40.2
	buf.build/gen/go/webitel/webitel-go/protocolbuffers/go v1.36.1-20250916131900-90d895efdd40.1
