...
func (CaseTimelineEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_case_timeline_proto_enumTypes[1].Descriptor()
}

func (CaseTimelineEventType) Type() protoreflect.EnumType {
	return &file_case_timeline_proto_enumTypes[1]
}
...
type CallFile struct {
	...
	Type          CallFileType           `protobuf:"varint,8,opt,name=type,proto3,enum=webitel.cases.CallFileType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_case_timeline_proto_rawDesc = "" +
	...
	"\astop_at\x18\x06 \x01(\x03R\x06stopAt\x12\x18\n" +
	"\achannel\x18\a \x01(\tR\achannel\x12/\n" +
	"\x04type\x18\b \x01(\x0e2\x1b.webitel.cases.CallFileTypeR\x04type\"_\n" +
	"\x10TranscriptLookup\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x16\n" +
	"\x06locale\x18\x02 \x01(\tR\x06locale\x12#\n" +
	"\x04file\x18\x03 \x01(\v2\x0f.general.LookupR\x04file*\x97\x01\n" +
	"\fCallFileType\x12\x13\n" +
	"\x0ffile_type_empty\x10\x00\x12\x18\n" +
	"\x14file_type_screenshot\x10\x01\x12\x1b\n" +
	"\x17file_type_screensharing\x10\x02\x12\x13\n" +
	"\x0ffile_type_audio\x10\x03\x12\x13\n" +
	"\x0ffile_type_video\x10\x04\x12\x11\n" +
	"\rfile_type_pdf\x10\x05*6\n" +
