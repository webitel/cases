...
const (
	...
	CaseTimeline_GetTimelineItemInfo_FullMethodName = "/webitel.cases.CaseTimeline/GetTimelineItemInfo"
)
...
type CaseTimelineClient interface {
	...
	GetTimelineItemInfo(ctx context.Context, in *GetTimelineItemInfoRequest, opts ...grpc.CallOption) (*GetTimelineItemInfoResponse, error)
}
...
func (c *caseTimelineClient) GetTimelineItemInfo(ctx context.Context, in *GetTimelineItemInfoRequest, opts ...grpc.CallOption) (*GetTimelineItemInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTimelineItemInfoResponse)
	err := c.cc.Invoke(ctx, CaseTimeline_GetTimelineItemInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CaseTimelineServer interface {
	...
	GetTimelineItemInfo(context.Context, *GetTimelineItemInfoRequest) (*GetTimelineItemInfoResponse, error)
...
func (UnimplementedCaseTimelineServer) GetTimelineCounter(context.Context, *GetTimelineCounterRequest) (*GetTimelineCounterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTimelineCounter not implemented")
}
func (UnimplementedCaseTimelineServer) GetTimelineItemInfo(context.Context, *GetTimelineItemInfoRequest) (*GetTimelineItemInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTimelineItemInfo not implemented")
}
...
func RegisterCaseTimelineServer(s grpc.ServiceRegistrar, srv CaseTimelineServer) {
	// If the following call panics, it indicates UnimplementedCaseTimelineServer was
...
func _CaseTimeline_GetTimelineItemInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTimelineItemInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CaseTimelineServer).GetTimelineItemInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CaseTimeline_GetTimelineItemInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CaseTimelineServer).GetTimelineItemInfo(ctx, req.(*GetTimelineItemInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CaseTimeline_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTimelineItemInfo",
			Handler:    _CaseTimeline_GetTimelineItemInfo_Handler,
		},
	},
