...
type Catalog struct {
	...
	// Default priority for cases created under this catalog
	DefaultPriority *Priority `protobuf:"bytes,21,opt,name=default_priority,json=defaultPriority,proto3" json:"default_priority,omitempty"`
...
func (x *Catalog) GetDefaultPriority() *Priority {
	if x != nil {
...
type InputCatalog struct {
	...
	// Default priority for cases created under this catalog (required)
	DefaultPriority *Lookup `protobuf:"bytes,12,opt,name=default_priority,json=defaultPriority,proto3" json:"default_priority,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *InputCatalog) GetDefaultPriority() *Lookup {
	if x != nil {
		return x.DefaultPriority
	}
	return nil
...
const file_catalog_proto_rawDesc = "" +
	"\n" +
	"\rcatalog.proto\x12\rwebitel.cases\x1a\rgeneral.proto\x1a\rservice.proto\x1a\x0epriority.proto\x1a\x1bgoogle/api/visibility.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1aproto/webitel/option.proto\"\x9c\x05\n" +
	"\aCatalog\x12\x0e\n" +
	...
	"\bsearched\x18\x14 \x01(\bR\bsearched\x12B\n" +
	"\x10default_priority\x18\x15 \x01(\v2\x17.webitel.cases.PriorityR\x0fdefaultPriority\"c\n" +
	"\vCatalogList\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x05R\x04page\x12\x12\n" +
	"\x04next\x18\x02 \x01(\bR\x04next\x12,\n" +
	"\x05items\x18\x03 \x03(\v2\x16.webitel.cases.CatalogR\x05items\"\x9d\x03\n" +
	...
	"\x06skills\x18\v \x03(\v2\x0f.general.LookupR\x06skills\x12:\n" +
	"\x10default_priority\x18\f \x01(\v2\x0f.general.LookupR\x0fdefaultPriority\"a\n" +
	...
	"\rLocateCatalog\x12#.webitel.cases.LocateCatalogRequest\x1a$.webitel.cases.LocateCatalogResponse\";\x92A\x18\x12\x16Locate a catalog by ID\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02\x16\x12\x14/cases/catalogs/{id}\x1a\x10\x8a\xb5\x18\fcase_lookupsB\xa0\x01\n" +
...
var file_catalog_proto_goTypes = []any{
	...
	(*Priority)(nil),              // 11: webitel.cases.Priority
}
var file_catalog_proto_depIdxs = []int32{
	...
	11, // 8: webitel.cases.Catalog.default_priority:type_name -> webitel.cases.Priority
	0,  // 9: webitel.cases.CatalogList.items:type_name -> webitel.cases.Catalog
	9,  // 10: webitel.cases.InputCatalog.sla:type_name -> general.Lookup
	9,  // 11: webitel.cases.InputCatalog.status:type_name -> general.Lookup
	9,  // 12: webitel.cases.InputCatalog.close_reason_group:type_name -> general.Lookup
	9,  // 13: webitel.cases.InputCatalog.teams:type_name -> general.Lookup
	9,  // 14: webitel.cases.InputCatalog.skills:type_name -> general.Lookup
	9,  // 15: webitel.cases.InputCatalog.default_priority:type_name -> general.Lookup
	2,  // 16: webitel.cases.CreateCatalogRequest.input:type_name -> webitel.cases.InputCatalog
	2,  // 17: webitel.cases.UpdateCatalogRequest.input:type_name -> webitel.cases.InputCatalog
	0,  // 18: webitel.cases.LocateCatalogResponse.catalog:type_name -> webitel.cases.Catalog
	6,  // 19: webitel.cases.Catalogs.ListCatalogs:input_type -> webitel.cases.ListCatalogRequest
	3,  // 20: webitel.cases.Catalogs.CreateCatalog:input_type -> webitel.cases.CreateCatalogRequest
	4,  // 21: webitel.cases.Catalogs.UpdateCatalog:input_type -> webitel.cases.UpdateCatalogRequest
	5,  // 22: webitel.cases.Catalogs.DeleteCatalog:input_type -> webitel.cases.DeleteCatalogRequest
	7,  // 23: webitel.cases.Catalogs.LocateCatalog:input_type -> webitel.cases.LocateCatalogRequest
	1,  // 24: webitel.cases.Catalogs.ListCatalogs:output_type -> webitel.cases.CatalogList
	0,  // 25: webitel.cases.Catalogs.CreateCatalog:output_type -> webitel.cases.Catalog
	0,  // 26: webitel.cases.Catalogs.UpdateCatalog:output_type -> webitel.cases.Catalog
	1,  // 27: webitel.cases.Catalogs.DeleteCatalog:output_type -> webitel.cases.CatalogList
	8,  // 28: webitel.cases.Catalogs.LocateCatalog:output_type -> webitel.cases.LocateCatalogResponse
