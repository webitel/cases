...
const file_close_reason_proto_rawDesc = "" +
	...
	"\x11LocateCloseReason\x12'.webitel.cases.LocateCloseReasonRequest\x1a(.webitel.cases.LocateCloseReasonResponse\"k\x92A\x1d\x12\x1bLocate a close reason by ID\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02A\x12?/close_reason_groups/{close_reason_group_id}/close_reasons/{id}\x1a\x10\x8a\xb5\x18\fdictionariesB\xa4\x01\n" +
