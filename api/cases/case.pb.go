...
type CaseNavDirection int32

const (
	CaseNavDirection_CASE_NAV_DIRECTION_UNSPECIFIED CaseNavDirection = 0
	CaseNavDirection_NEXT                           CaseNavDirection = 1
	CaseNavDirection_PREV                           CaseNavDirection = 2
)

// Enum value maps for CaseNavDirection.
var (
	CaseNavDirection_name = map[int32]string{
		0: "CASE_NAV_DIRECTION_UNSPECIFIED",
		1: "NEXT",
		2: "PREV",
	}
	CaseNavDirection_value = map[string]int32{
		"CASE_NAV_DIRECTION_UNSPECIFIED": 0,
		"NEXT":                           1,
		"PREV":                           2,
	}
)

func (x CaseNavDirection) Enum() *CaseNavDirection {
	p := new(CaseNavDirection)
	*p = x
	return p
}

func (x CaseNavDirection) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CaseNavDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_case_proto_enumTypes[0].Descriptor()
}

func (CaseNavDirection) Type() protoreflect.EnumType {
	return &file_case_proto_enumTypes[0]
}

func (x CaseNavDirection) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CaseNavDirection.Descriptor instead.
func (CaseNavDirection) EnumDescriptor() ([]byte, []int) {
...
type SearchCasesRequest struct {
	...
	FiltersV1     string                 `protobuf:"bytes,10,opt,name=filters_v1,json=filtersV1,proto3" json:"filters_v1,omitempty"` // Updated filters with CEL syntax.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SearchCasesRequest) GetFiltersV1() string {
	if x != nil {
		return x.FiltersV1
	}
	return ""
...
type LocateCaseRequest struct {
	...
	Qin           string   `protobuf:"bytes,4,opt,name=qin,proto3" json:"qin,omitempty"`
	Sort          string   `protobuf:"bytes,5,opt,name=sort,proto3" json:"sort,omitempty"`
	Filters       []string `protobuf:"bytes,6,rep,name=filters,proto3" json:"filters,omitempty"`
	FiltersV1     string   `protobuf:"bytes,7,opt,name=filters_v1,json=filtersV1,proto3" json:"filters_v1,omitempty"`
...
func (x *LocateCaseRequest) GetQ() string {
	if x != nil {
		return x.Q
	}
	return ""
...
func (x *LocateCaseRequest) GetQin() string {
	if x != nil {
		return x.Qin
	}
	return ""
...
func (x *LocateCaseRequest) GetSort() string {
	if x != nil {
		return x.Sort
	}
	return ""
...
func (x *LocateCaseRequest) GetFilters() []string {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *LocateCaseRequest) GetFiltersV1() string {
	if x != nil {
		return x.FiltersV1
	}
	return ""
...
func (x *LocateCaseRequest) GetContactId() string {
	if x != nil {
		return x.ContactId
	}
	return ""
...
type LocateCaseNeighborRequest struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	Etag      string                 `protobuf:"bytes,1,opt,name=etag,proto3" json:"etag,omitempty"`                                                // Etag of the case currently open, to step away from.
	Direction CaseNavDirection       `protobuf:"varint,2,opt,name=direction,proto3,enum=webitel.cases.CaseNavDirection" json:"direction,omitempty"` // Required: which way to step.
	...
	Qin           string   `protobuf:"bytes,5,opt,name=qin,proto3" json:"qin,omitempty"`
...
func (x *LocateCaseNeighborRequest) Reset() {
	*x = LocateCaseNeighborRequest{}
	mi := &file_case_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LocateCaseNeighborRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LocateCaseNeighborRequest) ProtoMessage() {}

func (x *LocateCaseNeighborRequest) ProtoReflect() protoreflect.Message {
	mi := &file_case_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LocateCaseNeighborRequest.ProtoReflect.Descriptor instead.
func (*LocateCaseNeighborRequest) Descriptor() ([]byte, []int) {
	return file_case_proto_rawDescGZIP(), []int{4}
}

func (x *LocateCaseNeighborRequest) GetEtag() string {
	if x != nil {
		return x.Etag
	}
	return ""
...
func (x *LocateCaseNeighborRequest) GetDirection() CaseNavDirection {
	if x != nil {
		return x.Direction
	}
	return CaseNavDirection_CASE_NAV_DIRECTION_UNSPECIFIED
}

func (x *LocateCaseNeighborRequest) GetFields() []string {
	if x != nil {
		return x.Fields
	}
	return nil
...
func (x *LocateCaseNeighborRequest) GetQ() string {
	if x != nil {
		return x.Q
	}
	return ""
...
func (x *LocateCaseNeighborRequest) GetQin() string {
	if x != nil {
		return x.Qin
	}
	return ""
...
func (x *LocateCaseNeighborRequest) GetSort() string {
	if x != nil {
		return x.Sort
	}
	return ""
...
func (x *LocateCaseNeighborRequest) GetFilters() []string {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *LocateCaseNeighborRequest) GetFiltersV1() string {
	if x != nil {
		return x.FiltersV1
	}
	return ""
...
func (x *LocateCaseNeighborRequest) GetContactId() string {
	if x != nil {
		return x.ContactId
	}
	return ""
...
type Case struct {
	...
	HasPrev bool `protobuf:"varint,42,opt,name=has_prev,json=hasPrev,proto3" json:"has_prev,omitempty"`
	HasNext bool `protobuf:"varint,43,opt,name=has_next,json=hasNext,proto3" json:"has_next,omitempty"`
	// Custom data extension fields ..
	Custom        *structpb.Struct `protobuf:"bytes,100,opt,name=custom,proto3" json:"custom,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ExportCasesRequest) Reset() {
	*x = ExportCasesRequest{}
	mi := &file_case_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExportCasesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExportCasesRequest) ProtoMessage() {}

func (x *ExportCasesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_case_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ExportCasesRequest) GetIds() []string {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *ExportCasesRequest) GetSort() string {
	if x != nil {
		return x.Sort
	}
	return ""
...
func (x *ExportCasesRequest) GetFields() []string {
	if x != nil {
		return x.Fields
	}
	return nil
...
func (x *ExportCasesRequest) GetFilters() []string {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *ExportCasesRequest) GetContactId() string {
	if x != nil {
		return x.ContactId
	}
	return ""
...
func (x *ExportCasesRequest) GetQin() string {
	if x != nil {
		return x.Qin
	}
	return ""
...
func (x *ExportCasesRequest) GetFiltersV1() string {
	if x != nil {
		return x.FiltersV1
	}
	return ""
...
type ExportCasesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// File data chunk (streamed in 64KB chunks)
	Data          []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ExportCasesResponse) Reset() {
	*x = ExportCasesResponse{}
	mi := &file_case_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExportCasesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExportCasesResponse) ProtoMessage() {}

func (x *ExportCasesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_case_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExportCasesResponse.ProtoReflect.Descriptor instead.
func (*ExportCasesResponse) Descriptor() ([]byte, []int) {
	return file_case_proto_rawDescGZIP(), []int{19}
}

func (x *ExportCasesResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_case_proto_rawDesc = "" +
	...
	"\achanges\x18\x02 \x03(\v2\x1a.webitel.cases.FieldChangeR\achanges\"\xf2\x01\n" +
	...
	"\n" +
	"filters_v1\x18\n" +
	" \x01(\tR\tfiltersV1\"\xcb\x01\n" +
	"\x11LocateCaseRequest\x12\x12\n" +
	"\x04etag\x18\x01 \x01(\tR\x04etag\x12\x16\n" +
	"\x06fields\x18\x02 \x03(\tR\x06fields\x12\f\n" +
	"\x01q\x18\x03 \x01(\tR\x01q\x12\x10\n" +
	"\x03qin\x18\x04 \x01(\tR\x03qin\x12\x12\n" +
	"\x04sort\x18\x05 \x01(\tR\x04sort\x12\x18\n" +
	"\afilters\x18\x06 \x03(\tR\afilters\x12\x1d\n" +
	"\n" +
	"filters_v1\x18\a \x01(\tR\tfiltersV1\x12\x1d\n" +
	"\n" +
	"contact_id\x18\b \x01(\tR\tcontactId\"\x92\x02\n" +
	"\x19LocateCaseNeighborRequest\x12\x12\n" +
	"\x04etag\x18\x01 \x01(\tR\x04etag\x12=\n" +
	"\tdirection\x18\x02 \x01(\x0e2\x1f.webitel.cases.CaseNavDirectionR\tdirection\x12\x16\n" +
	"\x06fields\x18\x03 \x03(\tR\x06fields\x12\f\n" +
	"\x01q\x18\x04 \x01(\tR\x01q\x12\x10\n" +
	"\x03qin\x18\x05 \x01(\tR\x03qin\x12\x12\n" +
	"\x04sort\x18\x06 \x01(\tR\x04sort\x12\x18\n" +
	"\afilters\x18\a \x03(\tR\afilters\x12\x1d\n" +
	"\n" +
	...
	"\x02dc\x18) \x01(\x03R\x02dc\x12\x19\n" +
	"\bhas_prev\x18* \x01(\bR\ahasPrev\x12\x19\n" +
	"\bhas_next\x18+ \x01(\bR\ahasNext\x12/\n" +
	...
	"\x10CaseNavDirection\x12\"\n" +
	"\x1eCASE_NAV_DIRECTION_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04NEXT\x10\x01\x12\b\n" +
	"\x04PREV\x10\x022\xb7\x06\n" +
	"\x05Cases\x12}\n" +
	"\vSearchCases\x12!.webitel.cases.SearchCasesRequest\x1a\x17.webitel.cases.CaseList\"2\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02(Z\x1e\x12\x1c/contacts/{contact_id}/cases\x12\x06/cases\x12q\n" +
	"\vExportCases\x12!.webitel.cases.ExportCasesRequest\x1a\".webitel.cases.ExportCasesResponse\"\x19\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02\x0f\x12\r/cases/export0\x01\x12^\n" +
	"\n" +
	"LocateCase\x12 .webitel.cases.LocateCaseRequest\x1a\x13.webitel.cases.Case\"\x19\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02\x0f\x12\r/cases/{etag}\x12w\n" +
	"\x12LocateCaseNeighbor\x12(.webitel.cases.LocateCaseNeighborRequest\x1a\x13.webitel.cases.Case\"\"\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02\x18\x12\x16/cases/{etag}/neighbor\x12^\n" +
	"\n" +
...
var file_case_proto_goTypes = []any{
	(CaseNavDirection)(0),              // 0: webitel.cases.CaseNavDirection
	(*FieldChange)(nil),                // 1: webitel.cases.FieldChange
	(*UpdateCaseResponse)(nil),         // 2: webitel.cases.UpdateCaseResponse
	(*SearchCasesRequest)(nil),         // 3: webitel.cases.SearchCasesRequest
	(*LocateCaseRequest)(nil),          // 4: webitel.cases.LocateCaseRequest
	(*LocateCaseNeighborRequest)(nil),  // 5: webitel.cases.LocateCaseNeighborRequest
	(*InputCreateCase)(nil),            // 6: webitel.cases.InputCreateCase
	(*CreateCaseCloseInput)(nil),       // 7: webitel.cases.CreateCaseCloseInput
	(*CreateCaseRelatedCaseInput)(nil), // 8: webitel.cases.CreateCaseRelatedCaseInput
	(*CreateCaseRequest)(nil),          // 9: webitel.cases.CreateCaseRequest
	(*UpdateCaseRequest)(nil),          // 10: webitel.cases.UpdateCaseRequest
	(*DeleteCaseRequest)(nil),          // 11: webitel.cases.DeleteCaseRequest
	(*CaseList)(nil),                   // 12: webitel.cases.CaseList
	(*Case)(nil),                       // 13: webitel.cases.Case
	(*CloseInfo)(nil),                  // 14: webitel.cases.CloseInfo
	(*SourceTypeLookup)(nil),           // 15: webitel.cases.SourceTypeLookup
	(*RateInfo)(nil),                   // 16: webitel.cases.RateInfo
	(*TimingInfo)(nil),                 // 17: webitel.cases.TimingInfo
	(*InputCase)(nil),                  // 18: webitel.cases.InputCase
	(*ExportCasesRequest)(nil),         // 19: webitel.cases.ExportCasesRequest
	(*ExportCasesResponse)(nil),        // 20: webitel.cases.ExportCasesResponse
	(*structpb.Value)(nil),             // 21: google.protobuf.Value
	(*Lookup)(nil),                     // 22: general.Lookup
	(*InputCaseLink)(nil),              // 23: webitel.cases.InputCaseLink
	(*structpb.Struct)(nil),            // 24: google.protobuf.Struct
	(RelationType)(0),                  // 25: webitel.cases.RelationType
	(*ExtendedLookup)(nil),             // 26: general.ExtendedLookup
	(*Priority)(nil),                   // 27: webitel.cases.Priority
	(*StatusCondition)(nil),            // 28: webitel.cases.StatusCondition
	(*Service)(nil),                    // 29: webitel.cases.Service
	(*CaseCommentList)(nil),            // 30: webitel.cases.CaseCommentList
	(*RelatedCaseList)(nil),            // 31: webitel.cases.RelatedCaseList
	(*CaseLinkList)(nil),               // 32: webitel.cases.CaseLinkList
	(*CaseFileList)(nil),               // 33: webitel.cases.CaseFileList
	(SourceType)(0),                    // 34: webitel.cases.SourceType
}
var file_case_proto_depIdxs = []int32{
	21, // 0: webitel.cases.FieldChange.old_value:type_name -> google.protobuf.Value
	21, // 1: webitel.cases.FieldChange.new_value:type_name -> google.protobuf.Value
	13, // 2: webitel.cases.UpdateCaseResponse.case:type_name -> webitel.cases.Case
	1,  // 3: webitel.cases.UpdateCaseResponse.changes:type_name -> webitel.cases.FieldChange
	0,  // 4: webitel.cases.LocateCaseNeighborRequest.direction:type_name -> webitel.cases.CaseNavDirection
	22, // 5: webitel.cases.InputCreateCase.assignee:type_name -> general.Lookup
	22, // 6: webitel.cases.InputCreateCase.reporter:type_name -> general.Lookup
	22, // 7: webitel.cases.InputCreateCase.impacted:type_name -> general.Lookup
	22, // 8: webitel.cases.InputCreateCase.group:type_name -> general.Lookup
	22, // 9: webitel.cases.InputCreateCase.status:type_name -> general.Lookup
	22, // 10: webitel.cases.InputCreateCase.close_reason_group:type_name -> general.Lookup
	22, // 11: webitel.cases.InputCreateCase.priority:type_name -> general.Lookup
