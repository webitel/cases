...
func (c *catalogsClient) ListCatalogs(ctx context.Context, in *ListCatalogRequest, opts ...grpc.CallOption) (*CatalogList, error) {
	...
	out := new(CatalogList)
	err := c.cc.Invoke(ctx, Catalogs_ListCatalogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogsClient) CreateCatalog(ctx context.Context, in *CreateCatalogRequest, opts ...grpc.CallOption) (*Catalog, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Catalog)
	err := c.cc.Invoke(ctx, Catalogs_CreateCatalog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogsClient) UpdateCatalog(ctx context.Context, in *UpdateCatalogRequest, opts ...grpc.CallOption) (*Catalog, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Catalog)
	err := c.cc.Invoke(ctx, Catalogs_UpdateCatalog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogsClient) DeleteCatalog(ctx context.Context, in *DeleteCatalogRequest, opts ...grpc.CallOption) (*CatalogList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CatalogList)
	err := c.cc.Invoke(ctx, Catalogs_DeleteCatalog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogsClient) LocateCatalog(ctx context.Context, in *LocateCatalogRequest, opts ...grpc.CallOption) (*LocateCatalogResponse, error) {
	...
	err := c.cc.Invoke(ctx, Catalogs_LocateCatalog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedCatalogsServer
...
// UnimplementedCatalogsServer should be embedded to have
...
func (UnimplementedCatalogsServer) testEmbeddedByValue() {}
...
func RegisterCatalogsServer(s grpc.ServiceRegistrar, srv CatalogsServer) {
	// If the following call pancis, it indicates UnimplementedCatalogsServer was
