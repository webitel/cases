...
const file_status_condition_proto_rawDesc = "" +
	...
	"\x15LocateStatusCondition\x12+.webitel.cases.LocateStatusConditionRequest\x1a,.webitel.cases.LocateStatusConditionResponse\"Q\x92A!\x12\x1fLocate a status condition by ID\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02#\x12!/statuses/{status_id}/status/{id}\x1a\x10\x8a\xb5\x18\fdictionariesB\xa8\x01\n" +
