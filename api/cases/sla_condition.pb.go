...
const file_sla_condition_proto_rawDesc = "" +
	...
	"\x12LocateSLACondition\x12(.webitel.cases.LocateSLAConditionRequest\x1a).webitel.cases.LocateSLAConditionResponse\"N\x92A\x1e\x12\x1cLocate an SLACondition by ID\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02#\x12!/slas/{sla_id}/sla_condition/{id}\x1a\x10\x8a\xb5\x18\fcase_lookupsB\xa5\x01\n" +
