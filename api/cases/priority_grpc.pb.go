...
func (c *prioritiesClient) ListPriorities(ctx context.Context, in *ListPriorityRequest, opts ...grpc.CallOption) (*PriorityList, error) {
	...
	err := c.cc.Invoke(ctx, Priorities_ListPriorities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *prioritiesClient) CreatePriority(ctx context.Context, in *CreatePriorityRequest, opts ...grpc.CallOption) (*Priority, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Priority)
	err := c.cc.Invoke(ctx, Priorities_CreatePriority_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *prioritiesClient) UpdatePriority(ctx context.Context, in *UpdatePriorityRequest, opts ...grpc.CallOption) (*Priority, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Priority)
	err := c.cc.Invoke(ctx, Priorities_UpdatePriority_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *prioritiesClient) DeletePriority(ctx context.Context, in *DeletePriorityRequest, opts ...grpc.CallOption) (*Priority, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Priority)
	err := c.cc.Invoke(ctx, Priorities_DeletePriority_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *prioritiesClient) LocatePriority(ctx context.Context, in *LocatePriorityRequest, opts ...grpc.CallOption) (*LocatePriorityResponse, error) {
	...
	err := c.cc.Invoke(ctx, Priorities_LocatePriority_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedPrioritiesServer
...
// UnimplementedPrioritiesServer should be embedded to have
...
func (UnimplementedPrioritiesServer) testEmbeddedByValue() {}
...
func RegisterPrioritiesServer(s grpc.ServiceRegistrar, srv PrioritiesServer) {
	// If the following call pancis, it indicates UnimplementedPrioritiesServer was
