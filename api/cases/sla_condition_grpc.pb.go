...
func (c *sLAConditionsClient) ListSLAConditions(ctx context.Context, in *ListSLAConditionRequest, opts ...grpc.CallOption) (*SLAConditionList, error) {
	...
	err := c.cc.Invoke(ctx, SLAConditions_ListSLAConditions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sLAConditionsClient) CreateSLACondition(ctx context.Context, in *CreateSLAConditionRequest, opts ...grpc.CallOption) (*SLACondition, error) {
	...
	err := c.cc.Invoke(ctx, SLAConditions_CreateSLACondition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sLAConditionsClient) UpdateSLACondition(ctx context.Context, in *UpdateSLAConditionRequest, opts ...grpc.CallOption) (*SLACondition, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SLACondition)
	err := c.cc.Invoke(ctx, SLAConditions_UpdateSLACondition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sLAConditionsClient) DeleteSLACondition(ctx context.Context, in *DeleteSLAConditionRequest, opts ...grpc.CallOption) (*SLACondition, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SLACondition)
	err := c.cc.Invoke(ctx, SLAConditions_DeleteSLACondition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sLAConditionsClient) LocateSLACondition(ctx context.Context, in *LocateSLAConditionRequest, opts ...grpc.CallOption) (*LocateSLAConditionResponse, error) {
	...
	err := c.cc.Invoke(ctx, SLAConditions_LocateSLACondition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedSLAConditionsServer
...
// UnimplementedSLAConditionsServer should be embedded to have
...
func (UnimplementedSLAConditionsServer) testEmbeddedByValue() {}
...
func RegisterSLAConditionsServer(s grpc.ServiceRegistrar, srv SLAConditionsServer) {
	// If the following call pancis, it indicates UnimplementedSLAConditionsServer was
