...
const file_case_communication_proto_rawDesc = "" +
	"\n" +
	"\x18case_communication.proto\x12\rwebitel.cases\x1a\rgeneral.proto\x1a\x1bgoogle/api/visibility.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1aproto/webitel/option.proto\"\xcb\x01\n" +
	"\x11CaseCommunication\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x03R\x02id\x12\x10\n" +
	"\x03ver\x18\x03 \x01(\x05R\x03ver\x12\x12\n" +
	"\x04etag\x18\x04 \x01(\tR\x04etag\x12U\n" +
	"\x12communication_type\x18\x05 \x01(\x0e2&.webitel.cases.CaseCommunicationsTypesR\x11communicationType\x12)\n" +
	"\x10communication_id\x18\x06 \x01(\tR\x0fcommunicationId\"\x9a\x01\n" +
	"\x16InputCaseCommunication\x12U\n" +
	"\x12communication_type\x18\x02 \x01(\x0e2&.webitel.cases.CaseCommunicationsTypesR\x11communicationType\x12)\n" +
