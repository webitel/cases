...
type CaseCommunication struct {
	...
	Communication   *Lookup                `protobuf:"bytes,5,opt,name=communication,proto3" json:"communication,omitempty"`                            // Type of the communication (e.g., Chat, Call).
...
func (x *CaseCommunication) GetCommunication() *Lookup {
	if x != nil {
...
type InputCaseCommunication struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Communication   *Lookup                `protobuf:"bytes,2,opt,name=communication,proto3" json:"communication,omitempty"`                            // Type of the communication.
...
func (x *InputCaseCommunication) GetCommunication() *Lookup {
	if x != nil {
		return x.Communication
	}
	return nil
...
const file_case_communication_proto_rawDesc = "" +
	"\n" +
	"\x18case_communication.proto\x12\rwebitel.cases\x1a\rgeneral.proto\x1a\x1bgoogle/api/visibility.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1aproto/webitel/option.proto\"\xab\x01\n" +
	...
	"\rcommunication\x18\x05 \x01(\v2\x0f.general.LookupR\rcommunication\x12)\n" +
	"\x10communication_id\x18\x06 \x01(\tR\x0fcommunicationId\"z\n" +
	"\x16InputCaseCommunication\x125\n" +
	"\rcommunication\x18\x02 \x01(\v2\x0f.general.LookupR\rcommunication\x12)\n" +
...
var file_case_communication_proto_depIdxs = []int32{
	8, // 0: webitel.cases.CaseCommunication.communication:type_name -> general.Lookup
	8, // 1: webitel.cases.InputCaseCommunication.communication:type_name -> general.Lookup
