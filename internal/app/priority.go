...
func (p *PriorityService) CreatePriority(ctx context.Context, req *api.CreatePriorityRequest) (*api.Priority, error) {
	...
	if e != nil {
		return nil, model.NewInternalError("priority_service.create_priority.store.create.failed", e.Error())
	}
...
func (p *PriorityService) ListPriorities(ctx context.Context, req *api.ListPriorityRequest) (*api.PriorityList, error) {
	session, err := p.app.AuthorizeFromContext(ctx)
	if err != nil {
		return nil, model.NewUnauthorizedError("priority.list_priorities.authorization.failed", err.Error())
	}
	...
	if e != nil {
		return nil, model.NewInternalError("priority.list_priority.store.list.failed", e.Error())
	}
...
func (p *PriorityService) UpdatePriority(ctx context.Context, req *api.UpdatePriorityRequest) (*api.Priority, error) {
	// Validate required fields
	if req.Id == 0 {
		return nil, model.NewBadRequestError("priority_service.update_priority.id.required", "Lookup ID is required")
	}

	session, err := p.app.AuthorizeFromContext(ctx)
	if err != nil {
		return nil, model.NewUnauthorizedError("priority_service.update_priority.authorization.failed", err.Error())
	}
	...
	if e != nil {
		return nil, model.NewInternalError("priority_service.update_priority.store.update.failed", e.Error())
	}
...
func (p *PriorityService) DeletePriority(ctx context.Context, req *api.DeletePriorityRequest) (*api.Priority, error) {
	// Validate required fields
	if req.Id == 0 {
		return nil, model.NewBadRequestError("priority.delete_priority.id.required", "Status ID is required")
	}

	session, err := p.app.AuthorizeFromContext(ctx)
	if err != nil {
		return nil, model.NewUnauthorizedError("priority.delete_priority.authorization.failed", err.Error())
	}
	...
	if e != nil {
		return nil, model.NewInternalError("priority.delete_priority.store.delete.failed", e.Error())
	}
...
func (p *PriorityService) LocatePriority(ctx context.Context, req *api.LocatePriorityRequest) (*api.LocatePriorityResponse, error) {
	// Validate required fields
	if req.Id == 0 {
		return nil, model.NewBadRequestError("priority_service.locate_priority.id.required", "Lookup ID is required")
	}
	...
	if err != nil {
		return nil, model.NewInternalError("priority_service.locate_priority.list_priorities.error", err.Error())
	}

	// Check if the close reason was found
	if len(listResp.Items) == 0 {
		return nil, model.NewNotFoundError("priority_service.locate_priority.not_found", "Priority not found")
	}
...
func NewPriorityService(app *App) (*PriorityService, model.AppError) {
	if app == nil {
		return nil, model.NewInternalError("api.config.new_priority_service.args_check.app_nil", "internal is nil")
	}
