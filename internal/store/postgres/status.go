...
func (s Status) Create(rpc *options.CreateOptions, add *_go.Status) (*_go.Status, error) {
...
func (s Status) List(rpc *opts.SearchOptions) (*_go.StatusList, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s Status) Delete(rpc *opts.DeleteOptions) error {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s Status) Update(rpc *options.GRPCUpdateOptions, l *_go.Status) (*_go.Status, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s Status) buildCreateStatusQuery(rpc *options.CreateOptions, lookup *_go.Status) (string, []interface{}, error) {
	args := []interface{}{
		lookup.Name,                     // $1 - name
...
func (s Status) buildSearchStatusQuery(rpc *opts.SearchOptions) (string, []interface{}, error) {
...
func (s Status) buildDeleteStatusQuery(rpc *opts.DeleteOptions) (string, []interface{}, error) {
	convertedIds := util.Int64SliceToStringSlice(rpc.IDs)
	ids := util.FieldsFunc(convertedIds, util.InlineFields)
...
func (s Status) buildUpdateStatusQuery(rpc *options.GRPCUpdateOptions, l *_go.Status) (string, []interface{}, error) {
