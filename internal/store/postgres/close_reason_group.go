...
func (s CloseReasonGroup) Create(rpc *options.CreateOptions, add *_go.CloseReasonGroup) (*_go.CloseReasonGroup, error) {
...
func (s CloseReasonGroup) List(rpc *opts.SearchOptions) (*_go.CloseReasonGroupList, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s CloseReasonGroup) Delete(rpc *opts.DeleteOptions) error {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s CloseReasonGroup) Update(rpc *options.GRPCUpdateOptions, l *_go.CloseReasonGroup) (*_go.CloseReasonGroup, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s CloseReasonGroup) buildCreateCloseReasonGroupQuery(rpc *options.CreateOptions, lookup *_go.CloseReasonGroup) (string, []interface{}, error) {
...
func (s CloseReasonGroup) buildSearchCloseReasonGroupQuery(rpc *opts.SearchOptions) (string, []interface{}, error) {
...
func (s CloseReasonGroup) buildDeleteCloseReasonGroupQuery(rpc *opts.DeleteOptions) (string, []interface{}, error) {
	convertedIds := util.Int64SliceToStringSlice(rpc.IDs)
	ids := util.FieldsFunc(convertedIds, util.InlineFields)
...
func (s CloseReasonGroup) buildUpdateCloseReasonGroupQuery(rpc *options.GRPCUpdateOptions, l *_go.CloseReasonGroup) (string, []interface{}, error) {
