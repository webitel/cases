...
func (s *SLAStore) Delete(rpc *opts.DeleteOptions) error {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s *SLAStore) List(rpc *opts.SearchOptions) (*cases.SLAList, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s *SLAStore) Update(rpc *options.GRPCUpdateOptions, l *cases.SLA) (*cases.SLA, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s SLAStore) buildCreateSLAQuery(rpc *options.CreateOptions, sla *cases.SLA) (string, []interface{}, error) {
...
func (s SLAStore) buildDeleteSLAQuery(rpc *opts.DeleteOptions) (string, []interface{}, error) {
...
func (s SLAStore) buildSearchSLAQuery(rpc *opts.SearchOptions) (string, []interface{}, error) {
	convertedIds := util.Int64SliceToStringSlice(rpc.IDs)
	ids := util.FieldsFunc(convertedIds, util.InlineFields)
...
func (s SLAStore) buildUpdateSLAQuery(rpc *options.GRPCUpdateOptions, l *cases.SLA) (string, []interface{}, error) {
