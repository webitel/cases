...
func (s Source) Create(rpc *options.CreateOptions, add *_go.Source) (*_go.Source, error) {
...
func (s Source) List(rpc *opts.SearchOptions) (*_go.SourceList, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s Source) Delete(rpc *opts.DeleteOptions) error {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s Source) Update(rpc *options.GRPCUpdateOptions, l *_go.Source) (*_go.Source, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s Source) buildCreateSourceQuery(rpc *options.CreateOptions, lookup *_go.Source) (string, []interface{}, error) {
...
func (s Source) buildSearchSourceQuery(rpc *opts.SearchOptions) (string, []interface{}, error) {
...
func (s Source) buildDeleteSourceQuery(rpc *opts.DeleteOptions) (string, []interface{}, error) {
	convertedIds := util.Int64SliceToStringSlice(rpc.IDs)
	ids := util.FieldsFunc(convertedIds, util.InlineFields)
...
func (s Source) buildUpdateSourceQuery(rpc *options.GRPCUpdateOptions, l *_go.Source) (string, []interface{}, error) {
