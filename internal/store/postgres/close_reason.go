...
func (s *CloseReason) Create(rpc *options.CreateOptions, add *_go.CloseReason) (*_go.CloseReason, error) {
...
func (s *CloseReason) List(rpc *opts.SearchOptions, closeReasonId int64) (*_go.CloseReasonList, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s *CloseReason) Delete(rpc *opts.DeleteOptions, closeReasonId int64) error {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s *CloseReason) Update(rpc *options.GRPCUpdateOptions, l *_go.CloseReason) (*_go.CloseReason, error) {
	d, dbErr := s.storage.Database()
	if dbErr != nil {
...
func (s CloseReason) buildCreateCloseReasonQuery(rpc *options.CreateOptions, lookup *_go.CloseReason) (string, []interface{}, error) {
...
func (s CloseReason) buildSearchCloseReasonQuery(rpc *opts.SearchOptions, closeReasonId int64) (string, []interface{}, error) {
...
func (s CloseReason) buildDeleteCloseReasonQuery(rpc *opts.DeleteOptions) (string, []interface{}, error) {
	convertedIds := util.Int64SliceToStringSlice(rpc.IDs)
	ids := util.FieldsFunc(convertedIds, util.InlineFields)
...
func (s CloseReason) buildUpdateCloseReasonQuery(rpc *options.GRPCUpdateOptions, l *_go.CloseReason) (string, []interface{}, error) {
